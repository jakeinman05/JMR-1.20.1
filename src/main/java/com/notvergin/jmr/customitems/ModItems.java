...
import com.notvergin.jmr.customitems.item.RefImmortalityGem;
...
public class ModItems
{
    ...
    public static final RegistryObject<Item> UIMMORTALITY_SWORD = ITEMS.register("uimmortality_sword",
            () -> new ImmortalBlade(ModToolTiers.IMMORTAL, 6, -2.4F, new Item.Properties().rarity(Rarity.EPIC).fireResistant()));
